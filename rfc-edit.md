...
The [IETF,](https://www.ietf.org/) [IAB](https://www.iab.com/), [IRTF](https://www.irtf.org/), [Independent](/authors/rfc-independent-submissions/), and [Editorial](https://datatracker.ietf.org/group/rswg/about/) Streams produce Internet-Drafts that are approved for publication by each stream’s own processes (see [How to Write an RFC](/authors/rfc-how-to/)). Once the approval steps are completed, the document is submitted to the RFC Production Center (RPC) for editing, formatting, and publication as an RFC.
