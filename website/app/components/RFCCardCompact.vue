<template>
  <BaseCard
    ...
    <div class="grid grid-cols-1 md:grid-cols-[calc(var(--computed-heading-char-length)*1.1ch)_minmax(0,_1fr)]">
      <span>
      ...
      <p
        class="relative z-1 mt-2 md:mt-0 ml-2 pl-4 border-l-1 border-gray-300 dark:border-gray-600 text-base text-blue-900 dark:text-white flex items-start">
        {{ props.rfc.title }}
      </p>
