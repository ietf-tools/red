<template>
  <DialogRoot v-model:open="isOpen" @close="isOpen = false">
    <DialogTrigger>
      <button class="button-shimmer button-highlight flex flex-row ml-2 sm:ml-4 gap-3 items-center cursor-pointer">
        <div
      ...
      <DialogContent class="fixed top-0 left-[50%] -ml-[10em] z-100 overflow-y-auto max-h-screen">
        <div
          ...
          <ul class="list-disc ml-5 text-sm flex flex-col gap-2">
            ...
            <li>
              <a :href="RED_BETA_GITHUB_ISSUES_URL" class="underline hover:bg-gray-100 focus:bg-gray-100">
          ...
          <ul class="list-disc ml-5 text-sm">
            <li>
              ...
              <a :href="useDatatrackerUrlOrigin()" class="underline"> Datatracker </a>
              and during IETF 124 this will be static and stale. Some information, particularly around author names and
              affiliations, will change to more closely match the current RFC Editor database before this is released
              into production.
            </li>
          ...
          <div class="text-sm">
            ...
            <span
              ...
              :class="
                isCopied
                  ? 'block w-full border-1 border-green-300 font-bold px-2 py-1 bg-green-200 dark:bg-green-700 text-sm mb-2'
                  : undefined
              ">
