<template>
  <fieldset class="w-full">
    ...
    <div class="w-full text-base">
      <ais-range-input ref="rangeInput" attribute="publicationDate">
          ...
          <div class="flex items-center">
            <div
              ...
              <select-root
                ...
                <select-trigger class="flex items-center" :aria-label="props.label + ' start year'">
                  <select-value placeholder="YYYY" />
                  <icon name="ph:caret-down-bold" size=".8em" class="ml-1" />
                </select-trigger>
                <select-portal>
                  <select-content class="bg-white dark:bg-black rounded-xs border shadow-sm z-[100]" :side-offset="5">
              ...
              <select-root
                ...
                <select-trigger class="flex items-center ml-2" :aria-label="props.label + ' start month'">
            ...
            <div
              ...
              <select-root
                ...
                <select-trigger class="flex items-center" :aria-label="props.label + ' end year'">
                  <select-value placeholder="YYYY" />
                  <icon name="ph:caret-down-bold" size=".8em" class="ml-1" />
                </select-trigger>
                <select-portal>
              ...
              <select-root
                ...
                <select-trigger class="flex items-center ml-2" :aria-label="props.label + ' end month'">
                  <select-value placeholder="MMM" />
                  <icon name="ph:caret-down-bold" size=".8em" class="ml-1" />
                </select-trigger>
                <select-portal>
...
function adaptUpdate(
  currentRange: UnixRange,
  rangeBounds: UnixRange,
  mode: UpdateMode,
  newValue: AcceptableValue
): UnixRange {
