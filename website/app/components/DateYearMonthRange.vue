<template>
  <fieldset class="w-full">
    ...
    <div
      ...
      <ais-range-input attribute="publicationDate" :min="minAisValue" :max="maxAisValue" :precision="0">
        <template #default="{ currentRefinement, refine }">
          <DateRangeFieldRoot
            ...
            @update:model-value="(val: DateRange) => refine(handleValueUpdate(val))">
...
const minDateRange = props.startRangeDate
  ? parseDate(props.startRangeDate).subtract({ days: 1 })
  : new CalendarDate(1968, 12, 31)
const maxDateRange = props.endRangeDate
