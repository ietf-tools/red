<template>
    <Heading
        level="1"
        style-level="1"
        class="bg-blue-900 text-white px-2 py-1 text-balance"
    >
        Search RFCs
    </Heading>
    <div class="sticky top-0 z-50 bg-blue-900 text-white mt-0 container mx-auto">
        <div class="flex flex-row items-center pt-4 pb-4 ml-2">
