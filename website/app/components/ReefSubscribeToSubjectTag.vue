  ...
  <div class="mt-5 lg:mt-0 relative flex flex-col md:flex-row md:gap-2">
    <div class="flex flex-col">
      <DialogRoot>
        <DialogTrigger
          type="button"
          class="text-pretty flex flex-row gap-2 cursor-pointer mt-2 px-1 md:px-2 py-1 md:py-1 font-bold text-blue-300 border-[2px] border-blue-300 dark:border-blue-200 hover:bg-blue-25 focus:bg-blue-25 dark:hover:bg-blue-500 dark:focus:bg-blue-500">
