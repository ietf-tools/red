<template>
  <!-- Icon from Fluent UI System Icons (fluent:star-24-filled) via Iconify -->
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" aria-hidden="true">
    <path
      class="stroke-2 stroke-[var(--star-stroke-color,var(--color-gray-500))] stroke-[length:var(--star-stroke-length,_0.2rem)] fill-current"
