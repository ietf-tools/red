<template>
  <!-- Icon from Framework7 Icons (f7:rectangle-grid-1x2-fill) via Iconify -->
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 56 56" aria-hidden="true">
    <path
      fill="currentColor"
