...
comparison failed. A run that did not cover a capture leaves it listed as unchanged. Re-record with
<code>npm run test:e2e:update-screenshots</code> once the changes are accepted.</p>
