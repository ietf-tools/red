...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    OIDC_CLIENT_REDIRECT_URI:
      | 'https://www.staging.rfc-editor.org/oidc/callback'
      | 'https://www.demo.rfc-editor.org/oidc/callback'
      | 'https://www.rfc-editor.org/oidc/callback'
    RFC_BUCKET: R2Bucket
    RED_BUCKET: R2Bucket
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'OIDC_ISSUER'
      | 'OIDC_CLIENT_AUTHORIZATION_ENDPOINT'
      | 'OIDC_CLIENT_TOKEN_ENDPOINT'
      | 'OIDC_CLIENT_KEYS_ENDPOINT'
      | 'OIDC_CLIENT_REDIRECT_URI'
    >
  > {}
}
