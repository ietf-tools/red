/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 29b09ccf82aeeedfab6ecd85c0989c7d)
// Runtime types generated with workerd@1.20260708.1 2025-06-16 nodejs_compat
interface __BaseEnv_Env {
  RFC_BUCKET: R2Bucket
  RED_BUCKET: R2Bucket
  INLINE_ERRATA_BUCKET: R2Bucket
  ENV_DOMAIN: '.staging'
  NUXT_PUBLIC_TYPESENSE_HOST: 'typesense.staging.ietf.org'
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ENV_DOMAIN' | 'NUXT_PUBLIC_TYPESENSE_HOST'>> {}
}
