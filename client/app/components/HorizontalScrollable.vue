<template>
  <div
    class="relative after:content-['_'] after:absolute after:left-0 after:top-0 after:w-full after:h-full after:pointer-events-none after:transition-shadow after:duration-800"
    :class="[props.class,
    {
